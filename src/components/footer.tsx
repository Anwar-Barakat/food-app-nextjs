            ...
            <Container>
                <div className="w-full  bg-hero/30 grid grid-cols-2 md:grid-cols-4 px-4 md:px-12 py-8">
                    ...
                    <div className="flex flex-col items-start justify-start gap-3">
                        ...
                        <p className="text-neutral-500 text-sm">+123 4567 8912</p>
                        <p className="text-neutral-500 text-sm">info@foodies.com</p>
                        <p className="text-neutral-500 text-sm">1234 Dubai, UAE</p>
                    </div>
                ...
                <div className="mx-auto py-8 ">
                    <p className="text-center text-xs text-black">
                        &copy; 2024 Foodies, Inc. All rights reserved
                    </p>
                </div>
            </Container>
        </footer>
